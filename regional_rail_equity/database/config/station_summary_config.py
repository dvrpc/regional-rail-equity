...
s1_am = StationSummaryFile(
    filename="2045_Scenario1_NewFare_RegRail_Trip_Stats.xlsx",
    skiprows=4,
    sheetname="AM",
...
s2_am = StationSummaryFile(
    filename="2045_Scenario2_NewFare_RegRail_Trip_Stats.xlsx",
    skiprows=4,
    sheetname="AM",
...
s3_am = StationSummaryFile(
    filename="2045_Scenario3_NewFare_RegRail_Trip_Stats.xlsx",
    skiprows=4,
    sheetname="AM",
